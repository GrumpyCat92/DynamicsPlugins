...
{
    public class AgreementPaiedInvoiceExistingValidation : CodeActivity
    {
        [Input("Agreement")]
        [RequiredArgument]
        ...
        [Output("Is an paied invoice exists")]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            var isInvoiceExists = agreementService.IsExistsPairdInvoice(agreement.Id);
