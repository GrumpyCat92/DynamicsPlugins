...
{
    public class AgreementInvoiceCreating : CodeActivity
    {
        [Input("Agreement")]
        [RequiredArgument]
        ...
        [Output("Date of agreement payment")]
        public OutArgument<DateTime> PaiedDate { get; set; }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            agreementService.CreateInvoices(agreement.Id);

            PaiedDate.Set(context, DateTime.Now.AddDays(1));
        }
    }
}
